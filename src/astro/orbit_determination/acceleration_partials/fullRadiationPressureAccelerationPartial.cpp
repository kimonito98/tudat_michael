...
void RadiationPressureAccelerationPartial::wrtArcWiseSourceDirectionScaling(
        Eigen::MatrixXd& partial,
...
void RadiationPressureAccelerationPartial::wrtArcWisePerpendicularDirectionScaling(
            Eigen::MatrixXd& partial,
            const std::shared_ptr< estimatable_parameters::ArcWiseRadiationPressureScalingFactor > parameter )
{
        Eigen::MatrixXd partialWrtSingleParameter = Eigen::Vector3d::Zero();
