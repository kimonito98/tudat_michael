...
{
    std::string timeDifferenceFileName = paths::getSpiceKernelPath( ) + "/inpop19a_TCB_m100_p100_asc/inpop19a_TCB_m100_p100_asc_pos_TCG.asc" ;
...
{
    std::string timeDifferenceFileName = paths::getSpiceKernelPath( ) + "/inpop19a_TDB_m100_p100_asc/inpop19a_TDB_m100_p100_asc_pos_TT.asc" ;
    std::map< double, std::vector< double > > timeEphemerisCoefficients = readInpopTimeEphemeris< double >( timeDifferenceFileName );
...
{
    std::string positionFileName = paths::getSpiceKernelPath( ) + "/inpop19a_TCB_m100_p100_asc/inpop19a_TCB_m100_p100_asc_pos_Ear.asc" ;
    std::string velocityFileName = paths::getSpiceKernelPath( ) + "/inpop19a_TCB_m100_p100_asc/inpop19a_TCB_m100_p100_asc_vel_Ear.asc" ;
...
{
    std::string positionFileName = paths::getSpiceKernelPath( ) + "/inpop19a_TDB_m100_p100_asc/inpop19a_TDB_m100_p100_asc_pos_Ear.asc" ;
    std::string velocityFileName = paths::getSpiceKernelPath( ) + "/inpop19a_TDB_m100_p100_asc/inpop19a_TDB_m100_p100_asc_vel_Ear.asc" ;
